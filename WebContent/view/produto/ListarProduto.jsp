		...
		<div class="row text-center">
			...
			<c:forEach var="p" items="${listaProduto}">
				<div class="col-lg-3 col-md-6 mb-4">
					<div class="card">
						<img class="card-img-top" src="./resources/img/${p.imagem}" alt="">
						<div class="card-body">
							<h4 class="card-title">${p.nomeProduto}</h4>
							<ul>
								<li>${p.localOrigemProduto}</li>
								<li>${p.quantidadeDisponivel}</li>
								<li class="card-text">R$ ${p.precoVenda}</li>
							</ul>
						</div>
						<div class="card-footer">
							<a href="#" class="btn btn-info">Comprar</a> <a
								href="exibirAtualizarProduto?id=${p.id}" class="btn btn-info">Alterar</a>
						</div>
					</div>
				</div>
			</c:forEach>
