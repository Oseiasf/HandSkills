	...
	<form action="CadastrarProduto" method="post" enctype="multipart/form-data">
				...
				<div class="contentform">
					...
					<div class="form-group">
						...
						<span class="icon-case"><i class="fa fa-align-left"></i></span>
					...
					<div class="form-group">
						...
						<select class="form-control" id="style-select" name="localOrigemProduto" >
					...
					<div class="form-group">
						...
						<span class="icon-case"><i class="fa fa-circle-o"></i></span> <input type="text" name="coresDisponiveis" maxlength="20" />
					</div>
				</div>
