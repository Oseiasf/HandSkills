...
<html>
	<head>
		...
		<title>Cadastrar um novo material</title>
	</head>
	<body id="corpoPadrao">
		...
		<div align="center">
			...
			<form action="cadastrarMaterial" method="post">
				...
				<div class="form-group">
    				<label for="inputCodigo">Descrição</label>
    				<input type="text" class="form-control" id="inputCodigo" name="descricao" style="width: 110px;" maxlength="50" required="required"> &nbsp;
  				</div>
