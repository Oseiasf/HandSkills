...
<html>
	...
	<body>
		...
		<!-- Page Content -->
		<div class="container">
			<div id="carouselExampleIndicators" class="carousel slide meu-carrosel" data-ride="carousel">
				...
				<div class="col-lg-3 col-md-6 mb-4">
					<div class="card">
						...
						<div class="card-footer">
							...
							<br>
							<a href="#" onclick="preencherModal('${p.nomeProduto}','${p.localOrigemProduto}', '${p.materialDoProduto.descricao}', '${p.quantidadeDisponivel}', '${p.precoVenda}', '${p.usuarioArtesao.nomeCompleto}' );" data-toggle="modal" data-target="#verMais" class="btn btn-info">Mais Informações</a>
						</div>
					</div>
				</div>
			</c:forEach>
